...
delay(0,function()
	local SillyBillies = {"Have fun! (you wont)","Good luck!","FUCK MUH","Extra help by realCat#3509","Do Not.","Fuck L_0 All my homies hate L_0","Holy ####... Lois","who tf is joe????"}
	message("Hardcore Initiated")
	task.wait(2)
	message("Made by noonie#0001 (Scripter) and Ping#1841 (Music composer and Modeler)")
	task.wait(4)
