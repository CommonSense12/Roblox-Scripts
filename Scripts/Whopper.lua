...
delay(0,function()
	local SillyBillies = {"You won't make it out alive","Hah, How long will you last?","This is impossible. There's no way","Fuck noonie and ping, They're skidding the shit out of us.","So desperate to escape the nightmare"}
	message("Impossible Mode Initiated")
	task.wait(2)
	message("Created by fuck noonie")
	task.wait(4)
...
local painters = 1
local paints = {
	[1] = {"rbxassetid://11881132074","Kys noonie (Kill yourself)"},
	[2] = {"rbxassetid://11881132745","Please noonie just die."},
	[3] = {"rbxassetid://11881654771","Noonie is a fucktard"},
	[4] = {"rbxassetid://7084794697","stfu."}
}
---
