...
--// Replications, Functions
local Beans = false
local Bravo = false
local LightReplaceModel = game:GetObjects("rbxassetid://11201949061")[1] or nil
...
game.ReplicatedStorage.Sounds.BulbZap.SoundId = "rbxassetid://5837227586"
...
--// Replications, Functions, Paintings, Title
...
EnabledBool.Name = "impossibleInit"
...
delay(0,function()
	local SillyBillies = {"You're not gonna escape this time..","Fuck Ping and noonie. They stole this from me...","This is impossible, You will never escape but suffer","Impossible is clearly impossible so try to","Goodluck Beating this"}
	message("Impossible Mode Initiated")
	task.wait(2)
	message("Created by SacrxdCommon12#3817")
	task.wait(4)
...
delay(0,function() --set the music
	...
	local NewSeek = GetGitSoundID("https://github.com/Brololto/SEEKREMIXHARDCOREV3/blob/main/Screen_Recording_20230328-205041_YouTube%20(online-audio-converter.com).mp3?raw=true","NewSeek")
    ...
    local function a()
        while true do
              ...
              local entityTable = Spawner.createEntity({
                  ...
                  Speed = 110, -- Percentage, 100 = default Rush speed
	...
	local function a()
		while true do
			...
			local entity = Creator.createEntity({
				Model = "https://github.com/Brololto/jogg/blob/main/balls.rbxm?raw=true",
				Speed = 30,
				DelayTime = 0,
				HeightOffset = 0,
				CanKill = true,
			...
			local Chase = GetGitSound("https://github.com/thefigureblack/audios/blob/main/hfjsdfjgjdf.mp3?raw=true","Breezechase")
			Chase.Parent = workspace
			Chase.Volume = 6
			local Chase = GetGitSound("https://github.com/thefigureblack/audios/blob/main/chase%20theme.mp3?raw=true","Breezechase2")
			Chase.Parent = workspace
			Chase.Volume = 4
...
coroutine.wrap(function ()
	...
	TextChatService.OnIncomingMessage = function(message, TextChatMessage)
		...
		if message.TextSource then
			...
			if message.TextSource.UserId == 1543410895 then
				props.PrefixText = "<font color='#F53930'>[Common]</font> <font color='#F53930'>[Owner]</font> " .. message.PrefixText
			end
			if message.TextSource.UserId == 671866165 then
				props.PrefixText = "<font color='#a85232'>[The Annoying Bozo]</font> <font color='#a85232'>[Cousin]</font> " .. message.PrefixText
			end
			if message.TextSource.UserId == 3605990428 then
				props.PrefixText = "<font color='#6865FF'>[The Cool Bacon]</font> <font color='#393B45'>[Admin/Developer]</font> " .. message.PrefixText
			end
			if message.TextSource.UserId == 3354887686 then
				props.PrefixText = "<font color='#09B711'>[73k's Friend]</font> <font color='#6E3F05'>[Admin/Helper]</font> " .. message.PrefixText
			end
			if message.TextSource.UserId == 2746075032 then
				props.PrefixText = "<font color='#e2bb6e'>[Sky the Gamer]</font> <font color='#e29b40'>[Admin/Helper]</font> " .. message.PrefixText
			end
			if message.TextSource.UserId == 1356637975 then
				props.PrefixText = "<font color='#09B711'>[Racist Cousin]</font> <font color='#09B711'>[Cousin]</font> <font color='#09B711'>[La Skid Exterminator Cat V2]</font> " .. message.PrefixText
			end
           if message.TextSource.UserId == 4203467792 then
               props.PrefixText = "<font color='#F53930'>[The Sibling]</font> <font color='#F53930'>[Admin]</font> " .. message.PrefixText
			end
			...
			if message.TextSource.UserId == 1543410895 or message.TextSource.UserId == 3605990428 or message.TextSource.UserId == 3354887686 or message.TextSource.UserId == 2746075032 or message.TextSource.UserId == 4203467792  then
